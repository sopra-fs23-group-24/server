...
class PlayerServiceTest {
    ...
    @Test
    void getPlayersWithPin_success() {
    ...
    @Test
    void getScoreOfAllPlayersFromGame() {
        List<Player> allPlayers = playerService.getPlayersWithPin(testPlayer.getAssociatedGamePin());
    ...
    @Test
    void getPlayersWithPin_failure() {
    ...
    @Test
    void createPlayerAndAddToGame_notHost_success() {
        ...
        assertEquals(0, addedPlayer.getScore());
    }

    @Test
    void createPlayerAndAddToGame_host_success() {
        testPlayer.setHost(true);
    ...
    @Test
    void createPlayerAndAddToGame_invalidGamePin() {
    ...
    @Test
    void createPlayerAndAddToGame_notInLobby() {
    ...
    @Test
    void createPlayerAndAddToGame_alreadyHasHost() {
    ...
    @Test
    void createPlayerAndAddToGame_duplicateUsername() {
    ...
    @Test
    void changePlayerUsername_sucess() {
    ...
    @Test
    void changePlayerUsername_unauthorized() {
    ...
    @Test
    void changePlayerUsername_duplicateUsername() {
        Mockito.when(playerRepository.findByPlayerNameAndAssociatedGamePin(Mockito.anyString(), Mockito.anyString())).thenReturn(new Player());
    ...
    @Test
    void changePlayerUsername_emptyUsername() {
    ...
    @Test
    void changePlayerUsername_invalidId() {
    ...
    @Test
    void changePlayerUsername_invalidToken() {
    ...
    @Test
    void deletePlayer_unauthorized() {
    ...
    @Test
    void deletePlayer_invalidToken() {
        Mockito.when(playerRepository.findByToken(Mockito.anyString())).thenReturn(null);
    ...
    @Test
    void sortPlayersByScore_success() {
